...
BusStop.activeStops    = {}
-- Return-trip state synced from server via ReturnTripSync command.
BusStop.returnStop   = nil   -- full stop table of the origin stop
BusStop.returnExpiry = nil   -- game world-hours at which the trip expires
...
function BusStop.priceLabel(fromX, fromY, dest)
    ...
    -- BusStopEconomy may not be loaded in all contexts; fall back gracefully.
